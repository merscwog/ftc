...
task main()
{
  ...
  // NOTE: Go backwards down the ramp
  while (abs(nMotorEncoder[leftMotor]) < inchesAsClicks(60))
  {
  	motor[leftMotor] = -30;
  ...
  // NOTE: Approach rolling goals
  while (abs(nMotorEncoder[leftMotor]) < inchesAsClicks(30))
  {
  	motor[leftMotor] = -20;
  	motor[rightMotor] = -20;  // Extra 1" for 10%, 2.5" for 25%, 3.5" for 50%
  }
