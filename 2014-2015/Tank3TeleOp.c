  ...
  while (true)
  {
    ...
    if (forwardIsFlipped) {
   	...
   	if (joystick.joy1_TopHat == 0) {
   		motor[leftMotor]  = 30 * flipMultiplier;
    	motor[rightMotor] = 30 * flipMultiplier;
    }
      ...
      motor[leftMotor]  = adjustThrottleValue(leftMotorSpeed);
      motor[rightMotor] = adjustThrottleValue(rightMotorSpeed);
    }
